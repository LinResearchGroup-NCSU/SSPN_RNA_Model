...
from openabc.lib import (_amino_acids, _amino_acid_1_letter_to_3_letters_dict, 
                         _dna_nucleotides, _dna_WC_pair_dict, _rna_nucleotides,
                         _rna_nucleotides_unaltered)
...
# The following functions have not been edited to be compatible with RNA. This is because either they required no changes or are not used in the SMOG3SPN2 model. 
...
def build_straight_CA_chain(sequence, r0=0.38):
    """
    Build a straight protein CA atom chain with given sequence. 
